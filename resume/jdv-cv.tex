...
\entry
{2026}
{Canadian Graduate Research Scholarship - Doctoral}
{NSERC}
{Canada's most competitive graduate scholarship, \$40,000k for 3 years.}
...
\paper{Richardson OE, Samiei M, Shakerinava M, \textcolor{highlight}{Viviano JD}, El Kabid A, Parviz A, Bengio Y. Local Inconsistency Resolution: The Interplay between Attention and Control in Probabilistic Models. arXiv, 2026.}
...
{A 3-hour workshop on how how to use Claude Code geared towards Undergraduate and Master's level students for \link{https://www.techaidemontreal.org/en/}{Techaide}}
