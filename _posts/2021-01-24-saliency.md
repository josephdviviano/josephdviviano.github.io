...
layout: post
current: post
cover: /assets/img/saliency/saliency-cover.png
navigation: True
...
![Bad Saliency]({{ '/assets/img/saliency/bad-saliency.png' | relative_url }})
{: refdef}
...
{:refdef: style="text-align: center;"}
![Bad Correlation]({{ '/assets/img/saliency/bad-correlation.png' | relative_url }})
{: refdef}
